...
{'code_point': 0x13112, 'others': [0x13BB2], 'comment': 'The appearance of 0x13112 has changed considerably and one could even argue that 0x13BB2 is closer to the original shape than to the new shape; both the original shape and 0x13BB2 clearly have sharp teeth while the new shape of 0x13112 does not. Gardiner (1957) characterizes the sign as "lower jaw-bone of ox", and as far as I know, oxen are not particularly known for having sharp teeth. But does this necessarily mean that the original shape of 0x13112 and 0x13BB2 differ in what they are meant to represent?'},
