...
{'code_point': 0x130FE, 'others': [],
'comment': 'The description suggests outward curving horns, unlike the Unicode 5.2 and Unicode 16 shapes. Some of the tokens in the TSL have outward curving horns and some have inward curving horns. Does it make sense to specify the curvature in the description when the curvature is so variable in actual inscriptions? How about just "with horns"?'},
