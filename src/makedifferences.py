...
'comment': 'The original shape (tail up) was misplaced at 0x13AE8. Will be solved in Unicode 17 by swapping the shapes and ancillary documention of 0x130FB and 0x13AE8 from Unicode 16.'},
...
{'code_point': 0x13169, 'others': [0x13168], 'comment': 'The width of 0x13169 should be the same as that of 0x13168, but the height should be less. See Gardiner (1957) for the typographical motivation.'},
{'code_point': 0x1316B, 'others': [0x1316A], 'comment': 'The width of 0x1316B should be the same as that of 0x1316A, but the height should be less. See Gardiner (1957) for the typographical motivation.'},
{'code_point': 0x131A6, 'others': [],
'comment': 'Around 2009, there were protracted discussions about what the most appropriate orientation was for Unicode, since both orientations occur in GEG. In consultation with Egyptologists it was decided to opt for the form in Unicode 5.2. Whether or not you agree this was the right decision, having studied (or not) the arguments laid out by Egyptologists in 2009, all this should be irrelevant. The glyph should not be changed relative to Unicode 5.2. Where the other orientation is needed, a variation selector for rotation can be used.'},
{'code_point': 0x131C6, 'others': [], 'comment': 'Revert to Unicode 5.2. The description in fact already correctly reflects the original shape.'},
...
{'code_point': 0x13227, 'others': [], 'comment': 'The differences may be insignificant, but it appears to me that most of the description matches the original shape better than the Unicode 16 shape. This sign deserves to be revisited by an expert'},
...
{'code_point': 0x13271, 'others': [], 'comment': 'In the original, the sides were not vertical but oblique.'},
...
{'code_point': 0x1334C, 'others': [0x1334B, 0x142B7, 0x142B8], 'comment': 'The original shape of 0x1334C seems to have a horizontal line on the top, so the new shape is not right, unless one can make a convincing case that the original shape was due to a misinterpretation. The intended use of 0x1334C is for "a later form of U23" (Gardiner 1931) as found on the 26th Dyn. sarcophagus of Ankhnesneferibra (EA32). There is a photo on the BM website (see below link), but I have been unable to spot any tokens of U23 that Gardiner might have had in mind. The Database refers to the Pyramid of Unas, which is off by more than 2 millennia so this is unlikely to be relevant to 0x1334C. It is unclear how the original shape of 0x1334C relates to other, newly introduced code points for hair-pins.',
'url': 'https://www.britishmuseum.org/collection/object/Y_EA32'},
{'code_point': 0x1335A, 'others': [], 'comment': 'The description matches the original shape but not the new shape. In the new shape the spindle is over the viper.'},
{'code_point': 0x13393, 'others': [], 'comment': 'Apart from plausible deniability (see above), the description fits the original shape but not the new shape. It would be better to revert to the Unicode 5.2 shape.'},
...
{'code_point': 0x1341B, 'others': [], 'comment': 'The description fits the original shape but not the new shape. Correct the new shape to have the top line curve downwards.'},
...
{'code_point': 0x130E8, 'others': [], 'comment': 'Unicode 5.2 form did not have uraeus. If the missing uraeus was clearly a mistake, then fine. But if there is a reasonable chance one could also find occurrences without uraeus, will you then introduce a new code point for this once this happens? This is disastrous for the stability of Unicode.'},
...
{'code_point': 0x13236, 'others': [], 'comment': 'Bow was mirrored.'},
{'code_point': 0x1323C, 'others': [], 'comment': 'Object on standard changed from looking similar to Y8 to something closer to R28.'},
...
{'code_point': 0x13247, 'others': [], 'comment': 'There was no basket in the original shape. I understand the information in the Database to suggest this sign also occurs without basket. It would therefore have been much better to keep the sign unchanged, as the original form is not objectively wrong.'},
...
def make_page(tables):
	...
	p.text = 'Where two glyphs are given for one code point, the first is from Unicode 5.2 and the second is from Unicode 16. The glyphs were automatically extracted from the officially published PDF code charts.'
