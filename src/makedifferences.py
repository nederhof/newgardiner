...
{'code_point': 0x13169, 'others': [0x13168], 'comment': 'The width of 0x13169 should be the same as that of 0x13168, but the height should be smaller. See Gardiner (1957) for the typographical motivation. Will be corrected in Unicode 17.'},
{'code_point': 0x1316B, 'others': [0x1316A], 'comment': 'The width of 0x1316B should be the same as that of 0x1316A, but the height should be smaller. See Gardiner (1957) for the typographical motivation. Will be corrected in Unicode 17.'},
...
{'code_point': 0x1334C, 'others': [0x1334B, 0x142B7, 0x142B8], 'comment': 'The original shape of 0x1334C seems to have a horizontal line on the top, so the new shape is not right, unless one can make a convincing case that the original shape was due to a misinterpretation. The intended use of 0x1334C is for "a later form of U23" (Gardiner 1931) as found on the 26th Dyn. sarcophagus of Ankhnesneferibra (EA32). There is a photo on the BM website (see below link), but I have been unable to spot any tokens of U23 that Gardiner might have had in mind. The Database refers to the Pyramid of Unas, which is off by more than 2 millennia so this is unlikely to be relevant to 0x1334C. It is unclear to me how the original shape of 0x1334C relates to other, newly introduced code points for hair-pins.',
